...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="assets/media/logos/logokesbangpol.png" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(assets/media/bg/bg_login.jpg);">
					...
					<div class="d-flex flex-column-fluid flex-center mt-10 mt-lg-0">
						...
						<div class="login-form login-signup">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signup_form">
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="text" placeholder="Nama Organisasi" name="namaorganisasi" autocomplete="off" />
								</div>
                                <div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="text" placeholder="Nama Ketua" name="namaketua" autocomplete="off" />
								</div>
                                <div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="text" placeholder="No. SK Pengurus" name="nosk" autocomplete="off" />
								</div>
                                <div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="text" placeholder="No. Telepon Ketua/Sekertaris" name="noketua" autocomplete="off" />
								</div>
                                <div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="text" placeholder="Username" name="username" autocomplete="off" />
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="email" placeholder="Email" name="email" autocomplete="off" />
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="password" placeholder="Password" name="password" autocomplete="off" />
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-3 px-4" type="password" placeholder="Confirm password" name="cpassword" autocomplete="off" />
								</div>
								{{-- <div class="form-group">
								...
								<div class="form-group d-flex flex-wrap">
									<button type="button" id="kt_login_signup_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3">SUBMIT</button>
									<button type="button" id="kt_login_signup_cancel" class="btn btn-secondary font-weight-bold px-9 py-4 my-3 mx-4">CANCEL</button>
								</div>
							</form>
							<!--end::Form-->
						</div>
