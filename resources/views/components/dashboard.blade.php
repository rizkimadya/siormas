@extends("components.index", ["title" => "Dashboard"])
@section("content")
											...
											<div class="card-body pb-3">
												<div class="flex-grow-1">
													...
													<div class="symbol symbol-50 pb-3">
															<span class="symbol">
																<img src="assets/media/svg/misc/IC-totalormas.svg" class="h-50 align-self-center" alt="" />
															</span>
													</div>
													
													<!--end::Info-->
													<!--begin::Link-->
													<p class="text-dark font-weight-bolder font-size-h2">52
													<!-- <br />Generator</a> -->
													<!--end::Link-->
													<!--begin::Desc-->
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body pb-3">
												<div class="flex-grow-1">
													...
													<div class="symbol symbol-50 pb-3">
															<span class="symbol">
																<img src="assets/media/svg/misc/IC-totalpermohonan.svg" class="h-50 align-self-center" alt="" />
															</span>
													</div>
													
													<!--end::Info-->
													<!--begin::Link-->
													<p class="text-dark font-weight-bolder font-size-h2">7
													<!-- <br />Generator</a> -->
													<!--end::Link-->
													<!--begin::Desc-->
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body pb-3">
												<div class="flex-grow-1">
													...
													<div class="symbol symbol-50 pb-3">
															<span class="symbol">
																<img src="assets/media/svg/misc/IC-Totalperdana.svg" class="h-50 align-self-center" alt="" />
															</span>
													</div>
													
													<!--end::Info-->
													<!--begin::Link-->
													<p class="text-dark font-weight-bolder font-size-h2">13
													<!-- <br />Generator</a> -->
													<!--end::Link-->
													<!--begin::Desc-->
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body pb-3">
												<div class="flex-grow-1">
													...
													<div class="symbol symbol-50 pb-3">
															<span class="symbol">
																<img src="assets/media/svg/misc/IC-Totalpelaporan.svg" class="h-50 align-self-center" alt="" />
															</span>
													</div>
													
													<!--end::Info-->
													<!--begin::Link-->
													<p class="text-dark font-weight-bolder font-size-h2">16
													<!-- <br />Generator</a> -->
													<!--end::Link-->
													<!--begin::Desc-->
